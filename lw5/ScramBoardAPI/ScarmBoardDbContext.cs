...
public class ScarmBoardDbContext : DbContext
{
    ...
    {
        //optionsBuilder.UseSqlServer(@"Server=(localdb)\MSSQLLocalDB;Database=LabWork5;Trusted_Connection=True;"); // ne rabotalo pochemu-to
        optionsBuilder.UseNpgsql(@"host=localhost;port=5432;database=LW5;user id=postgres;password=password;");
    }
